...
initTutorial({
    title: 'Jump builder',
    objective: 'When a player jumps, build a block on the location they were standing on. Jumping players have the vertical speed -52!',
    hint: 'Player locations are 16 times larger than block coordinates. When converting player locations to block coordinates, make sure to round your numbers properly!',
    toolbox: toolbox
});