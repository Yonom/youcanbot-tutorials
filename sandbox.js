...
toolbox += '    </category>';
toolbox += '    <sep></sep>';
toolbox += '    <category name="Actions" colour="0">';
toolbox += '        <block type="actions_smiley">';
toolbox += '            <value name="SMILEY">';
toolbox += '                <shadow type="enums_smiley">';
...
toolbox += '        </block>';
toolbox += '    </category>';
toolbox += '    <category name="Enums" colour="95">';
toolbox += '        <block type="enums_smiley"></block>';
toolbox += '    </category>';
toolbox += '    <sep></sep>';
toolbox += '    <category name="{catVariables}" colour="330" custom="VARIABLE">';
